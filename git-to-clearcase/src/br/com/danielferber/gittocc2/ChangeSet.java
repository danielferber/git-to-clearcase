...
public class ChangeSet {
    ...
    public final List<File> filesMovedModifiedSource;
    public final List<File> filesCopiedFrom;
    public final List<File> filesCopiedTo;
    public final List<File> filesCopiedModified;
    public final List<File> filesCopiedModifiedSource;

    public ChangeSet(final List<File> dirsAdded, final List<File> dirsDeleted, final List<File> filesAdded, final List<File> filesDeleted, final List<File> filesModified, final List<File> filesMovedFrom, final List<File> filesMovedTo, final List<File> filesMovedModified, final List<File> filesCopiedFrom, final List<File> filesCopiedTo, final List<File> filesCopiedModified) {
